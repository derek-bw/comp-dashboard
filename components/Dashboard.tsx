...
import { RepSummary, DealDetail, SheetData, CalculatorPrefill, MPESummary } from '@/types';
...
import DemosPlaceholder from './DemosPlaceholder';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        {!isManager && (
          <>
            ...
            {/* ── SDR: Demos placeholder (before SaaS OBE table) ────────── */}
            {repIsSDR && <DemosPlaceholder />}
